...
class JumbaqMenuScreen : Fragment(R.layout.screen_menu) {
    private val binding by viewBinding(ScreenMenuBinding::bind)
    private lateinit var menuAdapter: MenuAdapter
    private val args: JumbaqMenuScreenArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        menuAdapter = MenuAdapter(Controller.instance.getJumbaqList())
        ...
        menuAdapter.setListener {
            findNavController().navigate(
                JumbaqMenuScreenDirections.actionJumbaqMenuScreenToInfoJumbaqScreen(
                    it,
                    args.title
                )
            )
