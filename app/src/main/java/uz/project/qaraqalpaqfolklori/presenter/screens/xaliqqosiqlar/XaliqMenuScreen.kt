...
class XaliqMenuScreen : Fragment(R.layout.screen_menu) {
    private val binding by viewBinding(ScreenMenuBinding::bind)
    private lateinit var menuAdapter: MenuAdapter
    private val args: XaliqMenuScreenArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        menuAdapter = MenuAdapter(Controller.instance.getXaliqQosiqList())
        ...
        menuAdapter.setListener {
            findNavController().navigate(
                XaliqMenuScreenDirections.actionXaliqMenuScreenToInfoXaliqScreen(
                    it,
                    args.title
                )
            )
