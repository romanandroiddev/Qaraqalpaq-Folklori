package uz.project.qaraqalpaqfolklori.presenter.screens.janltpash
...
class JanltpashMenuScreen : Fragment(R.layout.screen_menu) {
    private val binding by viewBinding(ScreenMenuBinding::bind)
    private lateinit var menuAdapter: MenuAdapter
    private val args: JanltpashMenuScreenArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        menuAdapter = MenuAdapter(Controller.instance.getJanltpashList())
        ...
        menuAdapter.setListener {
            findNavController().navigate(
                JanltpashMenuScreenDirections.actionJanltpashMenuScreenToInfoJanltpashScreen(
                    it,
                    args.title
                )
            )
